...
@section('contents')
<div align="center">
    <form action="{{route('admin.allotTry.store')}}" method="post" style="margin-top: 100px">
    @csrf
        <div style="margin-top: 5px">
            <select name="subject_id" class="list-group-item">
                
         <option selected disabled>Select Subject</option>
         @foreach(App\Models\Subject::all()->where("course_type", "=", "THEORY") as $subject)
...
<table id=allotedsubjectstable>
    ...
    <tr>
        ...
        <td>{{$teacher->name}}</td>
        <td><a href="{{route('admin.delete_allotment_theory',$sub->id)}}" data-confirm="Are you sure to delete this item?"
