...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="{{asset('img/lab1.jpg')}}" alt="Chania">
        </div>

        <div class="item">
            <img src="{{asset('img/lab2.jpg')}}" alt="Chania">
        </div>

        <div class="item">
            <img src="{{asset('img/lab1.jpg')}}" alt="Flower">
        </div>

        <div class="item">
            <img src="{{asset('img/lab2.jpg')}}" alt="Flower">
        </div>
    </div>
</div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
            ...
            <div style="display:none" id="adminForm">
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="adminname" name="name" placeholder="Username ...">
                    </div>
                    <div class="form-group">
        ...
        <div style="display:none" id="facultyForm">
            <form action="{{route('teacher.login')}}" method="POST" style="overflow: hidden">
                @csrf
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="{{asset('img/faculty/donk.jpeg')}}" class="img-rounded"/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="{{asset('img/faculty/princi.jpeg')}}" class="img-rounded"/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="{{asset('img/faculty/cat.jpeg')}}" class="img-rounded"/>
